							...
							<div class="col-md-4 ">
								<div class="trend_2im clearfix position-relative">
									<div class="trend_2im1 clearfix">
										<div class="grid mb-3">
											<figure class="effect-jazz mb-0">
												<a href="#"><img src="<?php echo !empty($val->img) ? './admin/upload/videos/' . $val->img : 'https://img.onmanorama.com/content/dam/mm/en/entertainment/movie-reviews/images/2023/10/18/leo-poster.jpg'; ?>" height="240px" class="w-100" alt="img25"></a>
											</figure>
										</div>
									</div>
									<div class="trend_2im2 clearfix  position-absolute w-100 top-0">
