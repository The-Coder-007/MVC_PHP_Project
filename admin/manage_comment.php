								...
								<div class="tab-pane active" id="preview136">
									<table class="table table-hover table-centered mb-0">
										...
										<tbody>
											...
											?>
											<tr>
												<td><?php echo $val->feedback_id;?></td>
												<td><?php echo $val->user_id;?></td>
												<td><?php echo $val->video_id;?></td>
												<td><?php echo $val->comment;?></td>
												<td><?php echo $val->commented_at;?></td>
												
												<td>
													<h6 data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Edit" class="d-inline-block mb-0"><a href="edit_com?ecomment=<?php echo $val->feedback_id;?>"><i style="vertical-align:middle; margin-right:5px;" class="fa fa-edit col_3"></i></a></h6>
													<h6 data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Delete" class="d-inline-block mb-0"><a href="delete?dcomment=<?php echo $val->feedback_id;?>"><i class="fa fa-trash col_3"></i></a></h6>
												</td>
											</tr>
											<?php 
											}
