								...
								<div class="tab-pane active" id="preview136">
									<table class="table table-hover table-centered mb-0">
										...
										<tbody>
											<?php
											if (!empty($watchlist)) {
												foreach ($watchlist as $val) {
											?>
													<tr>
														<td><?php echo $val->watchlist_id; ?></td>
														<td><?php echo $val->user_id; ?></td>
														<td><?php echo $val->video_id; ?></td>
														<td><?php echo $val->watched_at; ?></td>
														...
														<td>
															...
															<h6 data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Delete" class="d-inline-block mb-0"><a href="delete?dwatchlist=<?php echo $val->watchlist_id; ?>"><i class="fa fa-trash col_3"></i></a></h6>
														</td>
													</tr>
												<?php
												}
