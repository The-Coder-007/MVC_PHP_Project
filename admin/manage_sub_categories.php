										...
										<tbody>
											...
											?>
													<tr>
														...
														<td><img src="upload/sub_category/<?php echo $val->img?>" width="50px" height="50px"></td>
														<td><?php echo $val->dt; ?></td>
														<td>
															<h6 data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Edit" class="d-inline-block mb-0"><a href="edit_sub?esub_cat=<?php echo $val->id; ?>"><i style="vertical-align:middle; margin-right:5px;" class="fa fa-edit col_3"></i></a></h6>
															<h6 data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Delete" class="d-inline-block mb-0"><a href="delete?dsub_cat=<?php echo $val->id; ?>"><i class="fa fa-trash col_3"></i></a></h6>
														</td>
													</tr>
												<?php
												}
