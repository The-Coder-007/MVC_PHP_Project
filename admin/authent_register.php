    ...
    <div class="row">
	 <div class="col-md-12">
	   <div class="autlog_1 reg_n1">
		 ...
		 <input class="form-control mt-3" type="email" name="username" placeholder="Email address">
		 <div class="row reg_ni">
		  ...
		  <div class="col-md-6">
		   <div class="reg_nil">
		    <input class="form-control mt-3" type="password" name="c_pass" placeholder="Confirm Password">
		   </div>
		  </div>
		 </div>
		 
		 <div class="form-check mt-4"><input class="form-check-input" type="checkbox" value="agree"><label class="form-label bold">I accept the <a class="colo_4" href="#">terms </a>and <a class="colo_4" href="#">privacy policy</a></label></div>
