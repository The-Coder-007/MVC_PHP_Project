  ...
  <div class="row center_o1">
   ...
   <div class="col-md-7">
     <div class="center_o1r text-end">
	  <h6 class="mb-0 col_red"><a href="home">Home</a> <span class="me-2 ms-2 text-light"><i class="fa fa-caret-right align-middle"></i></span> Top Rated</h6>
	 </div>
   </div>
  </div>
 </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="trend_2i row">
                            <?php
                            if (is_array($top_rated) && !empty($top_rated)) {
                                foreach ($top_rated as $i => $val) {
                            ?>
